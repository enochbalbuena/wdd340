...
VALUES   (
  ...
  -- Modify the description of "GM Hummer" to replace "small interiors" with "a huge interior"
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Update all records to add "/vehicles" to the file paths in `inv_image` and `inv_thumbnail`
UPDATE public.inventory
